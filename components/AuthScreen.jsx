...
export const AuthScreen = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (isLogin) {
            // Mock login
            login({ name: formData.name || 'Lucas', email: formData.email });
        } else {
            // Mock signup
        ...
        <div className="fixed inset-0 bg-[#0a0a0c] z-[100] flex items-center justify-center p-4 overflow-y-auto">
            ...
            <div className="glass-panel w-full max-w-xl p-8 md:p-12 relative animate-fade-in border-[var(--primary)] shadow-[0_0_50px_rgba(0,243,255,0.1)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[var(--primary)] hover:bg-white text-black py-5 rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-3 transition-all shadow-[0_0_30px_rgba(0,243,255,0.2)] hover:shadow-[0_0_40px_rgba(0,243,255,0.4)] hover:scale-[1.02] active:scale-[0.98] mt-4"
                    >
                        {isLogin ? 'Iniciar Sessão' : 'Configurar Sistema'}
                        <ArrowRight size={20} />
                    </button>
